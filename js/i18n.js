...
(function () {
  ...
  var translations = {
    ...
    ja: {
      ...
      'eng.career.timee.d2': 'ワーカー向けヘルスチェック機能担当チームの運営',
      ...
      'eng.projects.title': 'Personal Projects',
      'eng.projects.yomushi.description': 'ヘビー読者のための書籍ライフサイクル管理サービス。新刊・近刊のタイムラインブラウジング、ウィッシュリスト、本棚管理、バーコードスキャンによる蔵書登録など、「これから出る本を見つけて、気になる本をストックし、買ったら本棚に入れる」という一連のフローをシンプルに実現します。',
      'eng.projects.yomushi.note': '* 国立国会図書館サーチAPIを利用しているため、日本語書籍のみ対応しています。',
      'eng.projects.yomushi.features_title': '主な機能',
      'eng.projects.yomushi.f1': '新刊・近刊タイムライン（出版社フィルタ対応）',
      'eng.projects.yomushi.f2': '書名・著者の部分一致検索',
      'eng.projects.yomushi.f3': 'ウィッシュリスト & 本棚管理',
      'eng.projects.yomushi.f4': 'バーコードスキャンによる蔵書登録',
      'eng.projects.yomushi.f5': 'NDC分類・Cコードによるジャンル自動判定',
      'eng.projects.yomushi.stack_title': '技術スタック',
      ...
      'lang.translation.lex.description': '古代ローマ帝国を舞台にしたイタリア発のTTRPGルールブックの翻訳。イタリア語に加え、作中に登場するラテン語から日本語への訳出も行っており、日本語として初めて訳出される単語も含まれています。原書のフレーバーテキストや歴史的文脈を尊重しながら、日本語として自然に読める訳文を追求しました。Kickstarterキャンペーンの運営、SNSマーケティングも担当。',
      'lang.translation.lex.tag1': 'イタリア語→日本語',
      'lang.translation.lex.tag2': '翻訳',
      'lang.translation.lex.tag3': '校正・編集',
      'lang.translation.lex.link': 'Kickstarterページを見る →',
      'lang.translation.d100.subtitle': 'テーブルトークRPG / 英語 → 日本語',
      'lang.translation.d100.description': 'マジンガーZやゲッターロボなどの永井豪作品をテーマにしたTRPG、Dynamic D100の制作プロジェクト。ダイナミック企画株式会社様とのコミュニケーション・サポートで参加しています。',
    ...
    en: {
      ...
      'eng.career.timee.d2': 'Managing the Worker Health Check Feature Team',
      ...
      'eng.projects.title': 'Personal Projects',
      'eng.projects.yomushi.description': 'A book lifecycle management service for avid readers. Browse upcoming and new releases on a timeline, save books to your wishlist, manage your bookshelf, and register books by scanning barcodes — a simple workflow from discovering new titles to tracking your collection.',
      'eng.projects.yomushi.note': '* Japanese books only — powered by the National Diet Library Search API.',
      'eng.projects.yomushi.features_title': 'Key Features',
      'eng.projects.yomushi.f1': 'New & upcoming releases timeline (publisher filters)',
      'eng.projects.yomushi.f2': 'Partial-match search by title & author',
      'eng.projects.yomushi.f3': 'Wishlist & bookshelf management',
      'eng.projects.yomushi.f4': 'Barcode scanning for book registration',
      'eng.projects.yomushi.f5': 'Auto genre classification via NDC / C-Code',
      'eng.projects.yomushi.stack_title': 'Tech Stack',
      ...
      'lang.translation.lex.description': 'Translation of an Italian TTRPG rulebook set in the ancient Roman Empire. In addition to Italian, the work includes translation of Latin terms appearing in the source text into Japanese, some of which are the first-ever Japanese renderings. Maintained the original flavor text and historical context while creating natural Japanese prose. Also managed the Kickstarter campaign and social media marketing.',
      'lang.translation.lex.tag1': 'Italian → Japanese',
      'lang.translation.lex.tag2': 'Translation',
      'lang.translation.lex.tag3': 'Proofreading',
      'lang.translation.lex.link': 'View on Kickstarter →',
      'lang.translation.d100.subtitle': 'Tabletop RPG / English → Japanese',
      'lang.translation.d100.description': 'A TTRPG project themed around Go Nagai works such as Mazinger Z and Getter Robo. Participating as communication support with Dynamic Planning Inc.',
